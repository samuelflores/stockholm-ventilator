...
void loop()
{
  ...
  if (millis() >= waitPeriod)
  {
    ...
    genie.WriteObject(GENIE_OBJ_SCOPE,      0, gaugeVal);
    genie.WriteObject(GENIE_OBJ_SCOPE,      1, gaugeVal);
    
    genie.WriteObject(GENIE_OBJ_LED_DIGITS,      0, gaugeVal);
    genie.WriteObject(GENIE_OBJ_LED_DIGITS,      1, gaugeVal);
